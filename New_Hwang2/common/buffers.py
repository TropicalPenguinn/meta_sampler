...
class ReplayBuffer(object):
    ...
    def save(self,name):
        np.save("/home/airlab/PycharmProjects/MujocoTestbed/MetaTD3/{}_state.npy".format(name), self.obs1_buf)
        np.save("/home/airlab/PycharmProjects/MujocoTestbed/MetaTD3/{}_action.npy".format(name), self.acts_buf)
        np.save("/home/airlab/PycharmProjects/MujocoTestbed/MetaTD3/{}_next_state.npy".format(name), self.obs2_buf)
        np.save("/home/airlab/PycharmProjects/MujocoTestbed/MetaTD3/{}_reward.npy".format(name), self.rews_buf)
