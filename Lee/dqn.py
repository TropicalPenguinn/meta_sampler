...
class Meta_Aent(object):
    ...
    def update_parameters(self,replay_buffer):
        ...
        #print (obs1.shape,obs2.shape,acts.shape,rews.shape,done.shape)
        #print(acts)
        # Prediction Q(s)
        ...
        q_target = q_target.gather(1, self.qf(obs2).max(1)[1].unsqueeze(1))
        ...
        qf_loss = F.smooth_l1_loss(q, q_backup.detach())
