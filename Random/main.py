...
parser.add_argument('--random', type=float, default=0.0, metavar='G')
...
i = 0
while True:
    if os.path.exists('run/{}/Random_{}_{}/{}'.format(args.env_name,args.seed,args.random,i)):
        i += 1
    else:
        break
writer = SummaryWriter('run/{}/Random_{}_{}/{}'.format(args.env_name,args.seed,args.random, i))
...
for i_episode in itertools.count(1):
    ...
    while not done:
        ...
        meta_action=random.random()
        if meta_action<args.random:
